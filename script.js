...
const songs= [
    ...
    },
    {
        ...
        <div class="subtitle">Atif Aslma</div>`,
        poster:"img/13.jpg"
    },
    {
        id: '14',
    ...
    { 
        ...
        <div class="subtitle">Ali Sethi Sehar</div>`,
        poster:"img/18.jpg"
    },
    {
        id: '19',
...
Array.from(document.getElementsByClassName('playListPlay')).forEach((e)=>{
    e.addEventListener('click',(el)=>{
        ...
        // poster_master_play.src =`img/${index}.txt`;
        music.play();
        masterPlay.classList.remove('bi-play-fill');
        masterPlay.classList.add('bi-pause-fill');
...
// let vol_dot = documenet.getElementById('vol_dot');
...
vol.addEventListener('input', () => {
  let vol_val = parseInt(vol.value);
  let vol_width = vol.offsetWidth;
  let vol_left = vol.offsetLeft;

  let vol_bar_width = vol_val * vol_width / 100;
  vol_bar.style.width = vol_bar_width + 'px';

  let vol_dot_left = vol_val * vol_width / 100 + vol_left;
  vol_dot.style.left = vol_dot_left + 'px';
